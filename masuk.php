...
<html>
    <head>
        <title>Masuk Resep Kekinian</title>
        <link rel="stylesheet" type="text/css" href="style-masuk.css";>
    </head>

    <body>
        <menu>
            <ul>
                <li><a href="awal.html"><img src="gambar/logo.jpg"></a></li>
        ...
        <div class="kotak_masuk">
            <p class="tulisan_masuk">Masuk Akun</p>

            <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" >
                <label>Email</label>
                <input type="text" name="username" class="form_masuk" placeholder="Email">
